...
Object.keys(types).forEach(function (type) {
  ...
  var bufWriteMethodBE = 'write' + bufMethod + 'BE';
  var bufWriteMethodLE = 'write' + bufMethod + 'LE';

  var bufReadMethod = 'read' + bufMethod;
  var bufReadMethodBE = 'read' + bufMethod + 'BE';
  var bufReadMethodLE = 'read' + bufMethod + 'LE';

  var noEndian = bufMethod.indexOf('Int8') !== -1;
