...
ByteBuffer.prototype.putRowString = function (index, value) {
  ...
  this._checkSize(this._offset);
  value.copy(this._bytes, index);
  return this;
};

ByteBuffer.prototype.getRowString = function (index, length) {
  if (typeof index !== 'number') {
    index = this._offset++;
    return this._bytes[index].toString();
  }
  return this._bytes.slice(index, index + length).toString();
};

ByteBuffer.prototype.readRowString = function (length) {
  var index = this._offset;
  this._offset += length;
